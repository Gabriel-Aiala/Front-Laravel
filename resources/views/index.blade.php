        ...
        <div class="e-panel card">
          <div class="card-body">
            <div class="card-title">
              <h6 class="mr-2"><span>Clientes</span><small class="px-1"></small></h6>
            </div>
            <div class="e-table">
        ...
        <div class="card">
          <div class="card-body">
            <div class="text-center px-xl-3">
              <a class="btn btn-success btn-block" href="{{route('Criar-Cliente')}}" type="button" data-toggle="modal" data-target="#user-form-modal">Novo Cliente</a>
            </div>
            <hr class="my-3">
            <div class="e-navlist e-navlist--active-bold">
              <ul class="nav">
                <li class="nav-item active"><a href="" class="nav-link"><span>Total</span>&nbsp;<small>/&nbsp;32</small></a></li>
                <li class="nav-item"><a href="" class="nav-link"><span>ativos</span>&nbsp;<small>/&nbsp;16</small></a></li>
